...
{
    [Fact]
    public async Task Given_A_Request_That_Cannot_Be_Resolved_When_Handled_Then_No_Search_Start_Event_Is_Recorded()
    {
    ...
    [Fact]
    public async Task Given_A_Request_With_A_Weak_Top_Match_When_Handled_Then_No_Search_Start_Event_Is_Recorded()
    {
        var env = CatalogSearchRequestedHandlerTestEnvironment.WithNoExistingCandidates();
