...
using Soundtrail.Services.Enrichment.Worker.Features.OnLookupCanonicalMusicMetadata;

namespace Soundtrail.Services.Tests.Unit.Enrichment.Infrastructure;

internal sealed class LookupCanonicalMusicMetadataHandlerTestEnvironment
{
    ...
    private LookupCanonicalMusicMetadataHandlerTestEnvironment()
    {
        ...
        Handler = new LookupCanonicalMusicMetadataHandler(
            new LookupExecutionReceiptStoreFake(state),
            Metadata,
            SourceBudget);
    }

    public LookupCanonicalMusicMetadataHandler Handler { get; }

    public FakeGetCanonicalMusicMetadata Metadata { get; }

    public SourceApiBudgetPortFake SourceBudget { get; }

    public static LookupCanonicalMusicMetadataHandlerTestEnvironment Create() => new();
