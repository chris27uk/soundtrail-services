...
public sealed class MusicTrackCatalogProjectionTests
{
    ...
    public void Given_A_Provider_Resolution_Before_Hierarchy_When_Artist_Arrives_Then_Artist_And_Album_Inherit_Provider_State()
    {
        ...
        projection.Apply(new ArtistDiscovered("artist_the_killers", "The Killers", "mb-artist-the-killers", LookupSource.MusicBrainz, Clock), 2);
    ...
    public void Given_A_Provider_Failure_When_Applied_Then_Resolved_Providers_And_References_Are_Removed()
    {
        ...
        projection.Apply(new ProviderReferenceLookupFailed(ProviderName.YoutubeMusic, LookupSource.Odesli, Clock), 2);
    ...
    public void Given_A_Metadata_Correction_When_Applied_Then_Track_Artist_And_Album_Are_Repaired()
    {
        ...
        projection.Apply(new TrackDiscovered("Mr Brightside", "Killers", 222000, "USIR20400274", "mbid-1", LookupSource.MusicBrainz, Clock), 1);
    ...
    {
        var projection = new MusicTrackCatalogProjection(MusicCatalogId.From("mc_track_1"));
        projection.Apply(new TrackDiscovered("Mr. Brightside", "The Killers", 222000, "USIR20400274", "mbid-1", LookupSource.MusicBrainz, Clock), 1);
        projection.Apply(new ProviderReferenceDiscovered(ProviderName.Spotify, "spotify-1", new Uri("https://example.com/spotify-1"), LookupSource.Odesli, Clock), 2);
        ...
        projection.Apply(new AlbumDiscovered("album_hot_fuss", "Hot Fuss", "mb-release-hot-fuss", new DateOnly(2004, 6, 7), LookupSource.MusicBrainz, Clock), 4);
