...
internal sealed class GetTracksForPlaylistSociableTestEnvironment
{
    ...
    private readonly MessageHandlerMap messageHandlers;
        ...
        IReadOnlyList<LookupDataCompleteTrack> completedTracks)
    {
        ...
        messageHandlers = new MessageHandlerMap()
            .Add(new OnKnownMusicDataRequestedHandler(planner, discoveryRepository))
            .Add(new OnUnknownMusicDataRequestedHandler(planner, searchForCandidates, discoveryRepository))
            .Add(new OnMusicAssessmentRequiredHandler(assessmentPolicy, planningProjection, discoveryRepository))
            .Add(new LookupWorkReadyHandler(CommandBus))
            .Add(new LookupCompletedHandler(discoveryRepository, CommandBus))
            .Add(new LookupPlaylistTracksByProviderHandler(readPlaylistTracks, Clock, CommandBus))
            .Add(new LookupMusicbrainzSearchResultsHandler(readCatalogEntries, Clock, CommandBus))
            .Add(new LookupStreamingLocationByIsrcHandler(readTrack, readStreamingLocation, Clock, CommandBus))
            .Add(new LookupStreamingLocationByTrackMetadataHandler(readTrack, readStreamingLocation, Clock, CommandBus));
