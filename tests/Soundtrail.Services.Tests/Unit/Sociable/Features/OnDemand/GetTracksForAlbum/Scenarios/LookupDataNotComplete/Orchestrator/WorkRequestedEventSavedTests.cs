...
namespace Soundtrail.Services.Tests.Unit.Sociable.Features.GetTracksForAlbum.Scenarios.LookupDataNotComplete.Orchestrator;
...
public sealed class WorkRequestedEventSavedTests
{
    ...
    [Fact]
    public async Task Given_The_Request_Is_Orchestrated_Then_The_Target_Operation_Is_For_Album_Tracks()
    {
        var environment = GetTracksForAlbumSociableTestEnvironment.ForLookupDataNotComplete();
    ...
    [Fact]
    public async Task Given_The_Request_Is_Orchestrated_Then_The_Target_Contains_The_Album_Id()
    {
        var environment = GetTracksForAlbumSociableTestEnvironment.ForLookupDataNotComplete();
    ...
    [Fact]
    public async Task Given_The_Request_Is_Orchestrated_Then_The_Target_Has_The_Normalised_Album_Identifier()
    {
        var environment = GetTracksForAlbumSociableTestEnvironment.ForLookupDataNotComplete();
