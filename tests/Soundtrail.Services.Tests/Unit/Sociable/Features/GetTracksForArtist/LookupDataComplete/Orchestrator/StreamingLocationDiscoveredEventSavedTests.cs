...
public sealed class StreamingLocationDiscoveredEventSavedTests
{
    ...
    public async Task Then_The_Url_Comes_From_The_Input()
    {
        ...
        var environment = GetTracksForArtistSociableTestEnvironment.ForLookupDataComplete(InputTrack(streamingUrl: url));
    ...
    private static GetTracksForArtistSociableTestEnvironment ForTrackWithStreamingLocation() =>
        GetTracksForArtistSociableTestEnvironment.ForLookupDataComplete(InputTrack());

    private static LookupDataCompleteArtistTrack InputTrack(
    ...
    private static StreamingLocationDiscovered Event(GetTracksForArtistSociableTestEnvironment environment) =>
