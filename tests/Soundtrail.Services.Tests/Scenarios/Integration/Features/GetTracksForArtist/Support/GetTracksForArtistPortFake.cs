...
namespace Soundtrail.Services.Tests.Integration.Features.GetTracksForArtist.Support;
...
internal sealed class GetTracksForArtistPortFake : IGetTracksForArtistPort
{
    ...
    public void Seed(GetTracksForArtistResponse? tracks) => this.response = tracks;
