...
using Soundtrail.Services.Tests.Integration.Enrichment.Ports.ActiveLookupWorkStore.NewCommandId;

namespace Soundtrail.Services.Tests.Integration.Enrichment.Ports.ActiveLookupWorkStore.ExistingActiveLock;
