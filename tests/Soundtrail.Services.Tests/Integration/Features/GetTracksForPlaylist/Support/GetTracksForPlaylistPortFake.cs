...
namespace Soundtrail.Services.Tests.Integration.Features.GetTracksForPlaylist.Support;
...
internal sealed class GetTracksForPlaylistPortFake : IGetTracksForPlaylistPort
{
    ...
    {
        this.responses[response.PlaylistId] = response;
        return this;
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return this.resolver is null
            ? Task.FromResult(this.responses.GetValueOrDefault(playlistId))
            : this.resolver(playlistId, cancellationToken);
    }
}
