...
public sealed class MusicResolverApiFactory : WebApplicationFactory<Program>
{
...
{
    private readonly Dictionary<string, MusicResolver.Application.Search.SearchMusicResponse> _responses = new();

    public Task<MusicResolver.Application.Search.SearchMusicResponse?> GetAsync(
    ...
    public Task StoreAsync(
        NormalizedSearchQuery query,
        MusicResolver.Application.Search.SearchMusicResponse response,
        TimeSpan timeToLive,
        CancellationToken cancellationToken)
    {
