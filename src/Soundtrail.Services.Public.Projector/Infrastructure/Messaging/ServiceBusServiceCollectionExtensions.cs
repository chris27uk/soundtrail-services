...
namespace Soundtrail.Services.Public.Projector.Infrastructure.Messaging;

public static class ServiceBusServiceCollectionExtensions
{
    public static IServiceCollection AddPublicProjectorServiceBus(
    ...
    public static WolverineOptions UsePublicProjectorServiceBusMessaging(
