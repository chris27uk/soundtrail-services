...
public static class MusicBrainzDumpCommandLine
{
    ...
    public static string Usage() =>
        """
        Usage:
          dotnet run --project src/Soundtrail.Tools.Operations -- import --recording-dump <path> [--recording-dump <path>] [--release-dump <path>]
          dotnet run --project src/Soundtrail.Tools.Operations -- replay-catalog
          dotnet run --project src/Soundtrail.Tools.Operations -- replay-discovery-lifecycle
          dotnet run --project src/Soundtrail.Tools.Operations -- rebuild-all
