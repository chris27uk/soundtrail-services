...
public sealed class CatalogCandidateIdentifiedToWorkSubscriptionHostedService(
    IDocumentStore documentStore,
    IServiceScopeFactory scopeFactory,
    ITypeRegistry registry,
    ILogger<CatalogCandidateIdentifiedToWorkSubscriptionHostedService> logger) : BackgroundService
{
    private const string SubscriptionName = "catalog-candidate-identified-to-work";
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            {
                logger.LogError(ex, "Catalog candidate identified to work subscription failed.");
        ...
        CancellationToken cancellationToken)
    {
        ...
        var handler = scope.ServiceProvider.GetRequiredService<ApplyCatalogCandidateIdentifiedToWorkHandler>();
