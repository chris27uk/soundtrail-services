...
{
    private const string CheckpointId = "projector/checkpoints/catalog-item-changed";
    ...
    private async Task CatchUpAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var handler = scope.ServiceProvider.GetRequiredService<CatalogItemChangedProjectorHandler>();
