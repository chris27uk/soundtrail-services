...
public sealed class SearchMusicHandler(ITrackSearchPort trackSearch, IQueueLookupMusicRequest enqueueMusicRequest) : IHandler<SearchMusicRequest, SearchMusicResponse>
{
