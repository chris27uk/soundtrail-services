...
namespace Soundtrail.Services.Api.Features.GetTracksForArtist.Composition;
    ...
    Func<IServiceProvider, IGetTracksForArtistPort> createGetTracksForArtistPort) : IApiFeature
{
    ...
    {
        app.UseEndpoints(endpoints => endpoints.MapGetTracksForArtistEndpoints(AppTypeRegistry.ServiceLocation));
    }
}
