...
[Autodiscover]
public sealed class GetTracksForAlbumFeatureProduction : IApiFeature
{
    public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        GetTracksForAlbumComposition.Configure(services, new(
            sp => new RavenGetTracksForAlbumPort(
