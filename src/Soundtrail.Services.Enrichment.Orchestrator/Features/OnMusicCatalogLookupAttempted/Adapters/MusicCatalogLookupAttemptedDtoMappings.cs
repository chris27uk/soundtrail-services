...
internal static class MusicCatalogLookupAttemptedDtoMappings
{
    public static MusicCatalogLookupAttempted ToDomain(this MusicCatalogLookupAttemptedDto dto) =>
        new(
