...
namespace Soundtrail.Services.Enrichment.Orchestrator.Features.OnMusicAssessmentRequired.Composition;
...
public sealed class OnMusicAssessmentRequiredFeature : IOrchestratorFeature
{
    ...
    public void ConfigureMessaging(WolverineOptions options, IConfiguration configuration, IHostEnvironment environment)
    {
        ...
        options.ListenToAzureServiceBusQueue(serviceBusOptions.AssessMusicCatalogItemQueueName)
            .ProcessInline();
    }
}
