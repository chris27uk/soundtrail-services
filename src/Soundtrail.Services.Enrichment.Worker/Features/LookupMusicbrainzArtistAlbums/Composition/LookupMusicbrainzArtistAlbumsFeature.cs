...
namespace Soundtrail.Services.Enrichment.Worker.Features.LookupMusicbrainzArtistAlbums.Composition;

[Autodiscover]
public sealed class LookupMusicbrainzArtistAlbumsFeature : IFeature
{
