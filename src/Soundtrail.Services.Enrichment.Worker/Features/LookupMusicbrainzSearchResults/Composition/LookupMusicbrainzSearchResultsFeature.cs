...
public sealed class LookupMusicbrainzSearchResultsFeature : IFeature
{
    public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddAzureServiceBusListener<MusicBrainzLookupCommandDto, MusicBrainzLookupCommandDto>();
        ...
        services.AddLookupHandlerPipeline<LookupMusicbrainzSearchResultsMessage, LookupMusicbrainzSearchResultsDecoratorMetadata>(
            sp => new LookupMusicbrainzSearchResultsHandler(
        ...
        services.TryAddScoped<IHandler<MusicBrainzLookupCommandDto>, MusicBrainzLookupCommandHandler>();
    }
