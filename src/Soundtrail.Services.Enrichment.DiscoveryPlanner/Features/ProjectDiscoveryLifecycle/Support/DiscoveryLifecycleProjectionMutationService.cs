...
namespace Soundtrail.Services.Enrichment.DiscoveryPlanner.Features.ProjectDiscoveryLifecycle.Support;

public sealed class DiscoveryLifecycleProjectionMutationService
{
