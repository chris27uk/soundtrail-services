    ...
    IProviderSnapshotStore snapshotStore)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new EnrichmentOrchestrationResult(
            append.Appended ? append.AppendedFacts : Array.Empty<IMusicTrackEvent>());
    }
    ...
    private static EnrichmentResponseDto ToDto(EnrichmentResponse response) =>
        new(
...
{
    public IReadOnlyList<IMusicTrackEvent> Facts => Events;
}
