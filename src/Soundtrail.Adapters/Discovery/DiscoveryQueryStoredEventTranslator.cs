...
{
    public static DiscoveryQueryStoredEventRecordDto ToStoredEvent(
        DiscoveryQueryKey streamId,
        IDomainEvent @event,
        int version) =>
        @event switch
        {
            TrackMetadataLookupRequested required => ToStoredEvent(required.SearchCriteria, required, version),
            StreamingLocationsRequired required => ToStoredEvent(required.SearchCriteria, required, version),
            DiscoveryRequested requested => ToStoredEvent(requested.SearchCriteria, requested, version),
            DiscoveryPlanned planned => ToStoredEvent(planned.SearchCriteria, planned, version),
            DiscoveryDeferred deferred => ToStoredEvent(deferred.SearchCriteria, deferred, version),
            DiscoveryRejected rejected => ToStoredEvent(rejected.SearchCriteria, rejected, version),
            DiscoveryFailed failed => ToStoredEvent(failed.SearchCriteria, failed, version),
            DiscoveryStarted started => ToStoredEvent(started.SearchCriteria, started, version),
            DiscoveryCompleted completed => ToStoredEvent(completed.SearchCriteria, completed, version),
            KnownTrackRequestedEvent requested => ToStoredEvent(KnownCatalogItem.ForTrack(requested.TrackId), requested, version),
            ArtistCatalogLookupRequested requested => ToStoredEvent(KnownCatalogItem.ForArtist(requested.ArtistId), requested, version),
            AlbumCatalogLookupRequested requested => ToStoredEvent(KnownCatalogItem.ForAlbum(requested.AlbumId), requested, version),
    ...
    private static DiscoveryQueryStoredEventRecordDto ToStoredEvent(
        ...
        @event switch
        {
            ...
            {
                Id = DiscoveryQueryStoredEventRecordDto.GetDocumentId(DiscoveryQueryKey.StableValueFor(searchCriteria), version),
                Criteria = DiscoveryQueryKey.StableValueFor(searchCriteria),
                Version = version,
                ...
                TrackMetadataLookupRequested = new TrackMetadataLookupRequestedEventDataRecordDto(
                    DiscoveryQueryKey.StableValueFor(required.SearchCriteria),
                    required.TrustLevel,
                    required.RiskScore,
                    required.RequiredAt,
            ...
            DiscoveryRequested requested => new DiscoveryQueryStoredEventRecordDto
            {
                ...
                DiscoveryRequested = new DiscoveryRequestedEventDataRecordDto(
                    DiscoveryQueryKey.StableValueFor(requested.SearchCriteria),
            ...
            DiscoveryPlanned planned => new DiscoveryQueryStoredEventRecordDto
            {
                ...
                DiscoveryPlanned = new DiscoveryPlannedEventDataRecordDto(
                    DiscoveryQueryKey.StableValueFor(planned.SearchCriteria),
            ...
            DiscoveryDeferred deferred => new DiscoveryQueryStoredEventRecordDto
            {
                ...
                DiscoveryDeferred = new DiscoveryDeferredEventDataRecordDto(
                    DiscoveryQueryKey.StableValueFor(deferred.SearchCriteria),
            ...
            DiscoveryRejected rejected => new DiscoveryQueryStoredEventRecordDto
            {
                ...
                DiscoveryRejected = new DiscoveryRejectedEventDataRecordDto(
                    DiscoveryQueryKey.StableValueFor(rejected.SearchCriteria),
            ...
            DiscoveryFailed failed => new DiscoveryQueryStoredEventRecordDto
            {
                ...
                DiscoveryFailed = new DiscoveryFailedEventDataRecordDto(
                    DiscoveryQueryKey.StableValueFor(failed.SearchCriteria),
            ...
            DiscoveryStarted started => new DiscoveryQueryStoredEventRecordDto
            {
                ...
                DiscoveryStarted = new DiscoveryStartedEventDataRecordDto(
                    DiscoveryQueryKey.StableValueFor(started.SearchCriteria),
            ...
            DiscoveryCompleted completed => new DiscoveryQueryStoredEventRecordDto
            {
                ...
                DiscoveryCompleted = new DiscoveryCompletedEventDataRecordDto(
                    DiscoveryQueryKey.StableValueFor(completed.SearchCriteria),
    ...
    private static DiscoveryQueryStoredEventRecordDto ToStoredEvent(
        ...
        int version)
    {
        var persistentId = DiscoveryQueryKey.StableValueFor(knownItem);
    ...
    private static TrackMetadataLookupRequested ToTrackMetadataLookupRequested(DiscoveryQueryStoredEventRecordDto dto)
    {
        ...
        return new TrackMetadataLookupRequested(
            DiscoveryQueryKey.ToMusicSearchCriteria(data.Criteria),
            data.TrustLevel,
            data.RiskScore,
            data.RequiredAtUtc,
